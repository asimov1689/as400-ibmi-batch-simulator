...
-- Seed data
-- Fictional test data only. Names are Hitchhikers Guide to the Galaxy
-- character references, and ISIN-like values are dummy identifiers,
-- not real securities.
INSERT INTO CODELIVER1.PORTFOLIO
    (PORTF_ID, OWNER, CURRENCY, TOTAL_VALUE, STATUS, LAST_UPD)
VALUES
    ('PF001', 'Arthur Dent', 'USD', 150000.00, 'A', CURRENT_DATE);

INSERT INTO CODELIVER1.PORTFOLIO
    (PORTF_ID, OWNER, CURRENCY, TOTAL_VALUE, STATUS, LAST_UPD)
VALUES
    ('PF002', 'Ford Prefect', 'CHF', 280000.00, 'A', CURRENT_DATE);

INSERT INTO CODELIVER1.PORTFOLIO
    (PORTF_ID, OWNER, CURRENCY, TOTAL_VALUE, STATUS, LAST_UPD)
VALUES
    ('PF003', 'Trillian', 'EUR', 95000.00, 'I', CURRENT_DATE);

INSERT INTO CODELIVER1.PORTFOLIO
    (PORTF_ID, OWNER, CURRENCY, TOTAL_VALUE, STATUS, LAST_UPD)
VALUES
    ('PF004', 'Zaphod Beeblebrox', 'EUR', 320000.00, 'A', CURRENT_DATE);

INSERT INTO CODELIVER1.PORTFOLIO
    (PORTF_ID, OWNER, CURRENCY, TOTAL_VALUE, STATUS, LAST_UPD)
VALUES
    ('PF005', 'Marvin', 'PLN', 175000.00, 'A', CURRENT_DATE);
...
INSERT INTO CODELIVER1.TRADE_ORDERS
    (ORDER_ID, PORTF_ID, ISIN, QUANTITY, PRICE, ORDER_DT, PROCESS_DT, STATUS)
VALUES
    ('ORD-2026-004', 'PF004', 'TSH000000004', 150, 98.20,
     CURRENT_DATE, NULL, 'PEND');

INSERT INTO CODELIVER1.TRADE_ORDERS
    (ORDER_ID, PORTF_ID, ISIN, QUANTITY, PRICE, ORDER_DT, PROCESS_DT, STATUS)
VALUES
    ('ORD-2026-005', 'PF005', 'TSH000000005', 75, 210.00,
     CURRENT_DATE, NULL, 'PEND');
